...
const ProfileDetails = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow mt-10">
      <div className="flex flex-col md:flex-row gap-6 md:gap-8">
        <div className="flex-shrink-0 mx-auto md:mx-0">
          <img
            src={profile.img}
            alt={profile.name}
            className="w-full max-w-xs h-auto object-cover border rounded mb-4 md:mb-0"
          />
        </div>
        <div className="flex-1">
          <h1 className="text-2xl sm:text-3xl font-bold text-pink-700 mb-4">
            {profile.name}
          </h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-gray-700 mb-6">
            <div>
            ...
            <div>
              Height: <span className="font-semibold">{profile.height}</span>
            </div>
            <div>
              Weight: <span className="font-semibold">{profile.weight}</span>
            </div>
            <div>
            ...
            <div>
              Race: <span className="font-semibold">{profile.race}</span>
            </div>
            <div>
              Father's Name: <span className="font-semibold">{profile.father}</span>
            </div>
            <div>
              Mother's Name: <span className="font-semibold">{profile.mother}</span>
            </div>
            <div>
              Permanent Division:{" "}
              <span className="font-semibold">{profile.permanentDivision}</span>
            </div>
            <div>
              Present Division:{" "}
              <span className="font-semibold">{profile.presentDivision}</span>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button className="flex-grow sm:flex-grow-0 bg-pink-600 text-white px-5 py-2 rounded hover:bg-pink-700 font-semibold">
              Add to Favourites
            </button>
            <button className="flex-grow sm:flex-grow-0 bg-purple-600 text-white px-5 py-2 rounded hover:bg-purple-700 font-semibold">
